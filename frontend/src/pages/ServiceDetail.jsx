...
export default function ServiceDetail() {
  ...
  return (
    <section className="cw-section cw-page">
      <p><Link className="btn" to="/services"><Icon name="back" /> All Services</Link></p>
      ...
      <div style={{ marginTop: 'var(--sp-6)' }}>
        ...
        <p className="muted" style={{ marginTop: 'var(--sp-2)' }}>MOQs are explicit per product line — our overall minimum is around 10 pieces. Get in touch to confirm capacity for your quantity and timeline.</p>
      </div>
      <div style={{ marginTop: 'var(--sp-7)', display: 'flex', gap: 'var(--sp-3)', flexWrap: 'wrap', justifyContent: 'center' }}>
        <Link className="btn btn-gold" to={`/contact?type=quote&service=${svc.slug}`}>Get a Quote</Link>
      ...
      <p style={{ textAlign: 'center', marginTop: 'var(--sp-4)' }}>
        <Link className="btn" to="/services"><Icon name="back" /> Back to Services</Link>
      </p>
    </section>
  )
}
