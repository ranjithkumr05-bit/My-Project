...
import {REQUIRED_SLUGS, serviceBySlug, quoteHref, sampleHref, imgSrc} from '../data/services.js'
  ...
  return (
    <>
      <section className="cw-hero-fs">
        <video
          ref={videoRef}
          className="cw-hero-video"
          autoPlay
          muted
          loop
          playsInline
          preload="none"
          poster="/showcase/homepage-workfloor.jpg"
          src="/showcase/hero-loop.mp4"
          aria-hidden="true"
        />
        ...
        <div className="cw-hero-inner">
          <div className="cw-hero-left">
            <p className="cw-kicker-pill">
              <span className="dot" aria-hidden="true" /> Apparel · Workwear · Private Label
            </p>
            <h1>We build exactly to your spec.</h1>
            <p className="cw-hero-sub">
              Your Tiruppur partner for custom tees, teamwear, jerseys and private-label runs — from
              around 10 pieces, sampled before bulk, delivered to your door.
            </p>
            <div className="cw-hero-ctas">
              <Link className="cw-gold-btn" to={quoteHref()}>
                Get a Quote <Icon name="arrow" />
              </Link>
              <Link className="cw-ghost-btn" to="/services">
                Explore Services
              </Link>
            </div>
          </div>
      ...
      <section className="cw-section">
        <div className="cw-grid2 cw-trust">
          <img
            src="/showcase/step-discuss.jpg"
            alt="Fabric rolls selected for a production run"
            loading="lazy"
            width="1376"
            height="768"
          />
          <div>
            ...
            <p>
              We come from roughly 20 years of family garment experience in Tiruppur. Today that
              know-how runs your programme end to end — sourcing, cutting, printing/finishing
              arrangements, stitching, quality checking, packing and delivery — so a single enquiry
              covers the whole run.
            </p>
            <p className="muted">
              Minimums start around 10 pieces. Every bulk run follows an approved sample.
            </p>
            <div className="cw-workflow" aria-label="Manufacturing workflow">
              {[
                ...
                <span key={s} className="cw-flow-step">
                  <em>{i + 1}</em>
                  {s}
                </span>
              ))}
            ...
            <Link className="btn" to="/about">
              About our background <Icon name="arrow" />
            </Link>
          </div>
        </div>
      </section>
      ...
      <section className="cw-section">
        ...
        <ol className="cw-timeline">
          {[
            [
              ...
              'Product, quantity, sizes and target date — a tech pack helps, a rough note works.',
            ],
            [
              'Discuss apparel and design',
              'We confirm fabric, fit, colours and branding with you.',
            ],
            [
              'We coordinate production',
              'Sourcing, cutting, printing/finishing arrangements and stitching are lined up.',
            ],
            [
              'You approve the garments',
              'Finished lots are checked for measurements, seams and finish.',
            ],
        ...
        <div className="cw-steps-imgs" aria-hidden="true">
          {['step-discuss', 'step-production', 'step-deliver'].map((img) => (
            <img key={img} src={imgSrc(img)} alt="" loading="lazy" width="1376" height="768" />
          ))}
        </div>
      </section>
      ...
      <section className="cw-section cw-brandband">
        <div className="cw-grid2">
          <div>
            ...
            <p>
              Tell us how the garment should carry your brand. We confirm what is practical for your
              fabric and quantity before quoting.
            </p>
            <Link className="cw-gold-btn" to={quoteHref('private-label')}>
              Discuss private label <Icon name="arrow" />
            </Link>
          </div>
      ...
      <section className="cw-section cw-sample">
        <div className="cw-sample-inner">
          <div>
            ...
            <p>
              Tell us which apparel you are interested in and what you need. Contact our team to
              discuss sample availability and the next steps for your requirement.
            </p>
          </div>
          <Link className="cw-gold-btn" to={sampleHref()}>
            Request a Sample <Icon name="arrow" />
          </Link>
        </div>
      </section>
      ...
      <section className="cw-section cw-cta-band">
        ...
        <p className="cw-lead">
          Share your apparel requirements, approximate quantity, design ideas, and preferred
          timeline. Our team can discuss the next steps with you.
        </p>
