...
export default function About() {
  ...
  return (
    <section className="cw-section cw-page">
      ...
      <p className="cw-lead">
        A family-run B2B apparel manufacturer in Tiruppur for two decades — built around one
        promise: your brand, produced properly.
      </p>
      <div className="cw-grid2">
        ...
        <div>
          ...
          <p>
            ...
            printing, quality inspection and export packing — so a single enquiry covers the whole
            programme.
          </p>
          <h2>Built for B2B buyers</h2>
          <p>
            MOQs are explicit per product line. Every bulk run is preceded by a physical sample for
            approval. Production status is tracked through five defined stages, visible to you from
            enquiry to dispatch.
          </p>
      ...
      <div className="cw-photo-card">
        <img
          src="/showcase/homepage-workfloor.jpg"
          alt="Customwear manufacturing floor"
          loading="lazy"
          width="1024"
          height="576"
        />
        <div className="cw-photo-card-body">
          ...
          <p className="cw-photo-card-text">
            Cutting, stitching, print and packing run under one roof so quality never depends on a
